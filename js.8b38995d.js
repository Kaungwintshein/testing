...
exports.lerp = exports.getSiblings = exports.getMousePos = void 0;
  ...
  function Cursor(el) {
    ...
    this.onMouseMoveEv = function () {
      ...
      _gsap.gsap.to(_this.Cursor, {
        ...
        ease: "Power3.easeOut",
        opacity: 1
      }); //Excute Scale function


      _this.onScaleMouse(); // The window.requestAnimationFrame() method tells the browser that you wish to move.
  ...
  _createClass(Cursor, [{
    ...
    value: function onScaleMouse() {
      ...
      this.Item.forEach(function (link) {
        ...
        link.addEventListener("mouseenter", function () {
          _this2.setVideo(link); //Gsap Animation for scaling media


          _this2.scaleAnimation(_this2.Cursor.children[0], 0.8); // Scale down media on hover
    ...
    value: function render() {
      ...
      for (var key in this.cursorConfigs) {
        // WTF is LERP?
        // A lerp return the value between two numbers at a specific, decimal mid point
...
//# sourceMappingURL=/js.8b38995d.js.map